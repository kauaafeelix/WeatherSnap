const API_KEY = "a71b657df07c1226730daac45d849043";
        ...
        const iconMoon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>`;

        const coresClima = {
            Clear: 'bg-orange-400',
            Clouds: 'bg-slate-500',
            Rain: 'bg-blue-800',
            Thunderstorm: 'bg-zinc-900',
            Drizzle: 'bg-cyan-700',
            Snow: 'bg-sky-200',
            Default: 'bg-sky-500' 
        };
